...
print_frames(config_file='config.json', exp_img=exp_img, exp_title="CdTe coherent {111} twin boundary", progress_file="progress.txt", frame_selection="1-5", search_mode="gb", cmap="gray")
